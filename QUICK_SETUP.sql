-- MindClear Database Schema - Run this in Supabase SQL Editor
-- Go to: https://supabase.com/dashboard/project/josavjgczsfmzjnriuoj/sql
...
DROP POLICY IF EXISTS "Users can view own thought dumps" ON thought_dumps;
DROP POLICY IF EXISTS "Users can insert own thought dumps" ON thought_dumps;
DROP POLICY IF EXISTS "Users can update own thought dumps" ON thought_dumps;
...
DROP POLICY IF EXISTS "Users can view own clarity" ON daily_clarity;
DROP POLICY IF EXISTS "Users can insert own clarity" ON daily_clarity;
DROP POLICY IF EXISTS "Users can update own clarity" ON daily_clarity;
DROP POLICY IF EXISTS "Users can view own noise log" ON noise_log;
DROP POLICY IF EXISTS "Users can insert own noise log" ON noise_log;
